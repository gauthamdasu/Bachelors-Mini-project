...
THE NAME OF OUR EDITOR IS SAIGAUSMAN EDITOR
...
It also provide security feature of taking input password and a userid name for a user to work in the editor
...
1.In the password and while taking words backspace cannot be used.
	       
2.In the file while writing also cannot be used.
...
Gautam  :bst tree,red black tree ,tab feature,password.
Manish    :avl tree ,radix tree,editor.
